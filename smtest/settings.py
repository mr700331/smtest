...
# Build paths nside the project like this: os.path.join(BASE_DIR, ...)
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))


# Quick-start elopment settings - unsuitable for production
...
ANYMAIL={
	...
	'SENDGRID_MERGE_FIELD_FORMAT': "-{}-",
        'MAILGUN_USER': "",
        'MAILGUN_API_KEY': "",
	'MAILFUN_API_URL': "https://api.mailgun.net/v3/sandbox-KEY-.mailgun.org",
}
